...
% End TeX comment
% orig
% F^{a 4}_{4} ( - 2 A_{m} \partial_{n}{B^{m}} e_{a}^{n} - A_{m} B^{n} \partial_{n}{\phi} e_{a}^{m} - 2 B^{m} \partial_{m}{A_{n}} e_{a}^{n}) + F^{a 4}_{b} ( - 2 \partial_{m}{B^{n}} e_{a}^{m} e^{b}_{n} + B^{m} \partial_{m}{\phi} e_{a}^{n} e^{b}_{n} - 2 B^{m} \partial_{m}{e^{b}_{n}} e_{a}^{n}) + F^{a b}_{4} ( - 2 A_{a} A_{m} \partial_{n}{B^{m}} e_{b}^{n} - A_{a} A_{m} B^{n} \partial_{n}{\phi} e_{b}^{m} - 2 A_{a} B^{m} \partial_{m}{A_{n}} e_{b}^{n}) + F^{a b}_{c} ( - 2 A_{a} \partial_{m}{B^{n}} e_{b}^{m} e^{c}_{n} + A_{a} B^{m} \partial_{m}{\phi} e_{b}^{n} e^{c}_{n} - 2 A_{a} B^{m} \partial_{m}{e^{c}_{n}} e_{b}^{n})
% end_orig
\begin{dmath*}[compact, spread=2pt]
